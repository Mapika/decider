...
def test_staged_release_includes_server_module_closure(tmp_path):
    ...
    required_modules = {"batching.py", "prompt_fast.py", "engine_v2.py", "shared_prefix.py"}
    ...
    imported = subprocess.run(
        [sys.executable, "-c", "import decider.serve; import decider.engine_v2; import decider.shared_prefix"],
        cwd=release,
        env=env,
        capture_output=True,
        text=True,
