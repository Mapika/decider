"""Label game states with the scripted policy (plus random-action noise for coverage) -> decider Examples.
   python -m decider.mario_data data/mario.pkl [episodes_per_level]"""
import sys, random, pickle, numpy as np
import gym_super_mario_bros
from nes_py.wrappers import JoypadSpace
from gym_super_mario_bros.actions import SIMPLE_MOVEMENT
from .mario import describe, heuristic, tile, ACTIONS, RELEASE, INTRO
from .data import Example, Q, load_cache
