"""Play the games from pixels only: frame + intro -> typed decision (no text state).  python -m decider.games_pixels [model] [--games a,b] [--episodes 3] [--out f.json]"""
...
def main():
    ...
    if a.mario:
        ...
        from .mario import ACTIONS, RELEASE, INTRO
